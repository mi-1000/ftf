...
# tokenizer = MarianTokenizer.from_pretrained(romance_en)

# model = MarianMTModel.from_pretrained(romance_en)
...
# translated2 = model2.generate(**tokenizer2(list2, return_tensors="pt", padding=True))
